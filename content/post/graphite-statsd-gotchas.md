...
* And then there's <a href="http://graphite.readthedocs.org/en/latest/carbon-daemons.html#carbon-aggregator-py">
...
If Graphite performs any runtime consolidation it will always use
